...
setwd("C:/Users/mauricio.ibarra/Documents/IFOP/Proyectos/CTP/Orden_carpetas_crustáceos/2020/stock_LCN/rfiles")
getwd()
...
ano <- seq(1998,2018,1)
#---------------------------------------------#
anos <- seq(1998,2018,1)
years <- seq(1998,2018,1)
years_r <- seq(1999,2018,1)
...
png(file="C:/Users/mauricio.ibarra/Documents/IFOP/Proyectos/CTP/Orden_carpetas_crustáceos/2020/stock_LCN/figures/figure_1.png",
...
plot   (xx1, yy1, type="n", ylim=c(3000,max(yy1)),
