...
// parametros reclutamientos y mortalidades)
 ...
 init_bounded_vector log_Fm(1,ntime,-20,1,opt_F) // log  mortalidad por pesca por flota
 init_bounded_vector log_Fh(1,ntime,-20,1,opt_F) // log  mortalidad por pesca por flota
