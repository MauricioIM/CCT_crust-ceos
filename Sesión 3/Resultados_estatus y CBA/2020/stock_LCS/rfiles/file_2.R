...
ano <- seq(1968,2019,1)
#---------------------------------------------#
anos <- seq(1968,2019,1)
years <- seq(1968,2019,1)
years_r <- seq(1969,2019,1)
...
png(file="C:/Users/mauricio.ibarra/Documents/IFOP/Proyectos/CTP/Orden_carpetas_crustáceos/2020/stock_LCS/figures/figure_1.png",
