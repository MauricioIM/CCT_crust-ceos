...
ano_2020 <- seq(1961,2020,1)
ano_2019 <- seq(1961,2019,1)
ano_2018 <- seq(1961,2018,1)
ano_2017 <- seq(1961,2017,1)
...
png(file="C:/Users/mauricio.ibarra/Documents/IFOP/Proyectos/CTP/Orden_carpetas_crustáceos/2021/stock_CAN/figures/figure_6.png",
...
png(file="C:/Users/mauricio.ibarra/Documents/IFOP/Proyectos/CTP/Orden_carpetas_crustáceos/2021/stock_CAN/figures/figure_7.png",
    width=1200, height=700)
...
png(file="C:/Users/mauricio.ibarra/Documents/IFOP/Proyectos/CTP/Orden_carpetas_crustáceos/2021/stock_CAN/figures/figure_8.png",
    width=1200, height=700)

#X11()

plot(ano_2020,F_h1,type="l",ylab="Mortalidad por pesca (F)",xlab="Año", 
     main="Mortalidad por pesca", ylim=c(0,2), cex.lab=1,
...
png(file="C:/Users/mauricio.ibarra/Documents/IFOP/Proyectos/CTP/Orden_carpetas_crustáceos/2021/stock_CAN/figures/figure_9.png",
    width=1200, height=700)
