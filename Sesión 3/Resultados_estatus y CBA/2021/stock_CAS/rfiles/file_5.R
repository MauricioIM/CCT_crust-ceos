...
png(file="C:/Users/mauricio.ibarra/Documents/IFOP/Proyectos/CTP/Orden_carpetas_crustáceos/2021/stock_CAS/figures/figure_4.png",
    width=1200, height=700)

#windows()
plot(x,y, type = "l", lwd = 2, axes = F, xlim=c(3000, 15000), xlab = "BDo", ylab = "Probabilidad",
...
axis(side = 1, at = seq(3000, 15000, by=500), pos = 0, xlab="Probabilidad")
