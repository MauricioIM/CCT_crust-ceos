...
ano <- seq(1998,2017,1)
#---------------------------------------------#
anos <- seq(1998,2017,1)
years <- seq(1998,2017,1)
years_r <- seq(1999,2017,1)
...
png(file="C:/Users/mauricio.ibarra/Documents/IFOP/Proyectos/CTP/Orden_carpetas_crustáceos/2018/stock_LCN/figures/figure_1.png",
