...
void model_parameters::report(const dvector& gradients)
{
 ...
 report << "Prop machos_obs" << endl;
 report << (pobs_m)<< endl;
 report << "Prop machos_pred" << endl;
 report << (ppred_m)<< endl;
 report << "Prop hembras_obs" << endl;
 report << (pobs_h)<< endl;
 report << "Prop hembras_pred" << endl;
 report << (ppred_h)<< endl;
 report << "CRUCERO" << endl;
 report << "Prop machos_obs" << endl;
 report << (pobsc_m)<< endl;
