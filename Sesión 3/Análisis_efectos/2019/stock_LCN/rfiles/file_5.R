...
setwd("C:/Users/mauricio.ibarra/Documents/IFOP/Proyectos/CTP/Orden_carpetas_crustáceos/2019/stock_LCN/rfiles")
getwd()
...
png(file="C:/Users/mauricio.ibarra/Documents/IFOP/Proyectos/CTP/Orden_carpetas_crustáceos/2019/stock_LCN/figures/figure_4.png",
    width=1200, height=700)

#windows()
plot(x,y, type = "l", lwd = 2, axes = F, xlim=c(2500, 8500), xlab = "BDo", ylab = "Probabilidad",
...
axis(side = 1, at = seq(2500, 8500, by=500), pos = 0, xlab="Probabilidad")
axis(side = 2, at = seq(0, 1, by=0.0001), pos = 2500)
