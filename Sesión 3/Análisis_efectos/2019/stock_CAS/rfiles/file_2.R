...
setwd("C:/Users/mauricio.ibarra/Documents/IFOP/Proyectos/CTP/Orden_carpetas_crustáceos/2019/stock_CAS/rfiles")
getwd()
...
ano <- seq(1945,2018,1)
#---------------------------------------------#
anos <- seq(1945,2018,1)
years <- seq(1945,2018,1)
...
png(file="C:/Users/mauricio.ibarra/Documents/IFOP/Proyectos/CTP/Orden_carpetas_crustáceos/2019/stock_CAS/figures/figure_1.png",
...
plot   (xx1, yy1, type="n", ylim=c(5000,max(yy1)),
        ylab="Biomasa (t)",las=1,xlab="Año",cex.lab=1.2, cex.axis=1, main = "Biomasa total (t)")
...
plot(xx2, yy2, type="n", ylim=c(0,max(yy2)),
     ylab="Biomasa (ton)",las=1,xlab="Año",cex.lab=1.2, main = "Biomasa desovante (t)")
...
plot(xx4, yy4, type="n", ylim=c(0,max(yy4)),
     ylab="Reclutas (millones de hembras)",las=1,xlab="Año",cex.lab=1.2, main = "Reclutamiento")
