...
setwd("C:/Users/mauricio.ibarra/Documents/IFOP/Proyectos/CTP/Orden_carpetas_crustáceos/2020/stock_LCS/rfiles")
getwd()
...
png(file="C:/Users/mauricio.ibarra/Documents/IFOP/Proyectos/CTP/Orden_carpetas_crustáceos/2020/stock_LCS/figures/figure_4.png",
    width=1200, height=700)

#windows()

plot(x,y, type = "l", lwd = 2, axes = F, xlim=c(7000,90000), xlab = "BDo", ylab = "Probabilidad",
...
axis(side = 1, at = seq(7000, 90000, by=1000), pos = 0, xlab="Probabilidad")
