...
//!! ad_comm::change_datafile_name("mcrust_opt_sur.ctl");
...
REPORT_SECTION
 ...
 report << BMflo << endl;
 report << "Reclutamiento hembras predicho & Estimado" << endl;
 report << Rpred<< endl;
 ...
 report << "Prop_hembras_observado" << endl;
 report << prop_h << endl;
 report << "Prop_hembras_predicho" << endl;
 report << prop_hpred << endl;

 report << "Lm_machos_Observado" << endl;
 ...
 report << "Lh_hembras_Observado" << endl;
