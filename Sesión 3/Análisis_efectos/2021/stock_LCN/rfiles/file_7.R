...
png(file="C:/Users/mauricio.ibarra/Documents/IFOP/Proyectos/CTP/Orden_carpetas_crustáceos/2021/stock_LCN/figures/figure_6.png",
...
axis(1, at = 1998:2020, labels = 1998:2020, cex=0.8)  
...
png(file="C:/Users/mauricio.ibarra/Documents/IFOP/Proyectos/CTP/Orden_carpetas_crustáceos/2021/stock_LCN/figures/figure_7.png",
    width=1200, height=700)
...
png(file="C:/Users/mauricio.ibarra/Documents/IFOP/Proyectos/CTP/Orden_carpetas_crustáceos/2021/stock_LCN/figures/figure_8.png",
    width=1200, height=700)

#X11()

plot(ano_2020,Ft1,type="l",ylab="Mortalidad por pesca (F)",xlab="Año", 
     main="Mortalidad por pesca", ylim=c(0,4), cex.lab=1,
...
ano_2020_r <- seq(1999,2020,1)
ano_2019_r <- seq(1999,2018,1)
ano_2018_r <- seq(1999,2018,1)
ano_2017_r <- seq(1999,2017,1)
...
png(file="C:/Users/mauricio.ibarra/Documents/IFOP/Proyectos/CTP/Orden_carpetas_crustáceos/2021/stock_LCN/figures/figure_9.png",
    width=1200, height=700)
...
axis(1, at = 1999:2020, labels = 1999:2020, cex=1.3)
