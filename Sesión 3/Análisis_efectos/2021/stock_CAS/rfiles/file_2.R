...
ano <- seq(1945,2020,1)
#---------------------------------------------#
anos <- seq(1945,2020,1)
years <- seq(1945,2020,1)
...
png(file="C:/Users/mauricio.ibarra/Documents/IFOP/Proyectos/CTP/Orden_carpetas_crustáceos/2021/stock_CAS/figures/figure_1.png",
