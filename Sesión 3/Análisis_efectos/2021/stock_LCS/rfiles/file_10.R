...
population_mean_2020 <- exp(std[115,"value"])
population_sd_2020 <- std[115,"std.dev"]

class(std)

#define population mean and standard deviation 2019

population_mean_2019 <-  exp(std2[113,"value"])
population_sd_2019 <- std2[113,"std.dev"]


#define population mean and standard deviation 2018

population_mean_2018 <-  exp(std3[111,"value"])
population_sd_2018 <- std3[111,"std.dev"]

#define population mean and standard deviation 2017

population_mean_2017 <- exp(std4[123,"value"])
population_sd_2017 <- std4[123,"std.dev"]
...
png(file="C:/Users/mauricio.ibarra/Documents/IFOP/Proyectos/CTP/Orden_carpetas_crustáceos/2021/stock_LCS/figures/figure_12.png",
